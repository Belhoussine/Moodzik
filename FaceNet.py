...
EmotioNet = model_from_json(open(models_path + "Model_1_0.81/EmotioNet_1.json", "r").read())
EmotioNet.load_weights(models_path + 'Model_1_0.81/EmotioNet_weights_1.h5')

# Loading FaceNet model
FaceNet = cv2.CascadeClassifier(models_path + 'haar_cascade/haarcascade_frontalface_default.xml')
...
while(True):
    ...
    for (x, y, w, h) in detected_faces:
        ...
        cv2.rectangle(frame, (x, y), (x+w, y+h), (100, 200, 100), thickness=5)
        ...
        cv2.putText(frame, prediction, (int(x), int(y)), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2)  
